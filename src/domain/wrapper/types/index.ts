 ...
 * generated class's own shape, and the four type functions that apply a
 * multiplicity to the inner class's input, read, raw and schema forms.
 *
...
export type { WrappedSchemaOf } from "./wrapped-schema-of.type";
