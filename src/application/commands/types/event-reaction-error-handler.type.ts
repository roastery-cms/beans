...
/**
 * `EventedCommandsOptions.onError`'s shape: how a reaction's failure becomes
 ...
 *
 * If this itself throws, `commands` falls back to its unconditional
 ...
 * @see `EventedCommandsOptions.onError` — the only place this type is used.
 */
