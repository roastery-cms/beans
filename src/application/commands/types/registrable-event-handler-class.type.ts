import type { CommandsSpecBase } from "@/application/commands/types";
import type { AugmentedDependencies } from "@/application/commands/types/augmented-dependencies.type";
 ...
 *   what `commands` actually has available (the raw `Dependencies`
 ...
 * @see `IEventedCommands.on` — the only consumer.
 */
