 ...
 * @see `CommandsOf` — the intersection this half belongs to.
 * @see `ICommands.get` — the explicit form, kept for dynamic or
 *   non-identifier keys.
 */
export type CommandRunnersOf<Spec extends CommandsSpecBase, Dependencies> = {
