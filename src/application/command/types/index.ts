 ...
 * pillar's vocabulary, and the `commands` pillar cannot own it without
 ...
 * - {@link CommandsSpecBase} — the base constraint of a `commands` spec, and of a `Siblings` map.
...
export type { CommandsSpecBase } from "./commands-spec-base.type";
