 ...
 * stay one level deeper, at dedicated subpaths (`@roastery/beans/entity/helpers`,
 ...
 * `@roastery/beans/domain-event`.
 *
 * Re-exports:
 * - {@link blueprint} — declares a blueprint carrying domain rules (`default` / `derive`); its original home is `@roastery/beans/entity/helpers`.
