 ...
 *
 * @see `Entity.raiseEvent` in `@roastery/beans/entity` — the only place that constructs this shape.
 * @see `Entity.pullDomainEvents` in `@roastery/beans/entity` — drains the buffer these accumulate into.
